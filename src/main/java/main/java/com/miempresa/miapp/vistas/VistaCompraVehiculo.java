 ...
 * @author JUAN
 */
public class VistaCompraVehiculo extends javax.swing.JFrame {

    /**
     * Creates new form VistaCompraVehiculo
     */
    public VistaCompraVehiculo() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VistaCompraVehiculo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VistaCompraVehiculo().setVisible(true);
            }
        });
    }
